...
def move_one_object_pc(obj_xyz, obj_rgb, object_params, struct_params=None, euler_angles=False):
...
def show_pcs_with_labels(xyz, rgb, predictions, add_coordinate_frame=False, return_buffer=False, add_table=True, side_view=True):
    """ Display point clouds """
...
def show_pcs_color_order(xyzs, rgbs, add_coordinate_frame=False, side_view=False, add_table=True):
